...
theme.config = {
  ...
  mediaQuerySmall: "screen and (max-width: 900px)",
  youTubeReady: false,
  vimeoReady: false,
  vimeoLoading: false,
...
(function () {
  ...
  theme.rteInit = function () {
    ...
    function wrapVideo(iframe) {
      ...
      // ****************************zeus20231115*****************************************************
      if (iframe.classList[0] !== "seanzeus") {
  ...
  theme.ProductScreen = (function () {
    ...
    function ProductScreen(id, name) {
      ...
      this.nodes = {
        loader: document
          .getElementById("OverscrollLoader")
          .querySelector(".icon-loader__path"),
      ...
      this.isOpen = false;
      this.focusOnOpen = config.focusOnOpen
        ? this.screen.querySelector(config.focusOnOpen)
        : this.screen;
    ...
    ProductScreen.prototype = Object.assign({}, ProductScreen.prototype, {
      ...
      close: function (evt, args) {
        ...
        var bodyCloseClass = noAnimate
          ? config.bodyClosingClass
          : config.bodyCloseAnimate;
  ...
  theme.QuickShopScreens = (function () {
    ...
    function getProductIds(scope) {
      ...
      var triggers = scope
        ? scope.querySelectorAll(selectors.trigger)
      ...
      for (var i = 0; i < ids.length; i++) {
        if (activeIds.indexOf(ids[i]) === -1) {
          ...
          if (screenLayer) {
            ...
            if (
              original &&
              original.parentNode.classList.contains("hotspot-content__block")
            ) {
    ...
    function removeDuplicateModals(ids, container) {
      for (var i = 0; i < ids.length; i++) {
        var duplicate = container.querySelector(
  ...
  theme.slideNav = (function () {
    ...
    function openNav(evt) {
      navWrapper.style.overflow = "visible"; //seanzeus20231108

      document.body.classList.add("mb-menu-open");
      ...
      if (pageSlide) {
        var navWrapperHeight = document.querySelector(
          selectors.navWrapper
        ).clientHeight;
        container.style.transform =
          "translate3d(0, " + navWrapperHeight + "px, 0)";
      }

      navWrapper.setAttribute("tabindex", "-1");
      navWrapper.focus();

      navWrapper.scrollTop = 0; //seanzeus20231108
    ...
    function closeNav(evt) {
      document.body.classList.remove("mb-menu-open");
      ...
      var btns = document.querySelectorAll(
        selectors.subNavToggleBtn + '[data-level="' + (menuLevel - 1) + '"]'
      );
      btns.forEach((btn) => {
        btn.classList.remove(classes.isActive);
      });
    ...
    function goToSubnav(target) {
      ...
      menuLevel = targetMenu.dataset.level
        ? parseInt(targetMenu.dataset.level)
        : 1;
      ...
      if (pageSlide) {
        container.style.transform =
          "translate3d(0, " + translateMenuHeight + "px, 0)";
      }
    }
  ...
  theme.pageTransitions = function () {
    if (document.body.dataset.transitions === "true") {
      ...
      document
        .querySelectorAll(
          'a[href^="mailto:"], a[href^="#"], a[target="_blank"], a[href*="youtube.com/watch"], a[href*="youtu.be/"], a[href*="player.vimeo.com/video/"], a[href*="vimeo.com/"], a[download]'
        )
        .forEach((el) => {
  ...
  theme.headerNav = (function () {
    ...
    function init() {
      ...
      window.on(
        ...
        theme.utils.debounce(150, headerResize)
      );
      ...
      window.on(
        ...
        theme.utils.throttle(150, stickyMenuOnScroll)
      );
      // Make sure it fires after scrolling, to be safe and sure
      // the height is properly set
      window.on(
        "scroll" + config.namespace,
        theme.utils.debounce(150, stickyMenuOnScroll)
      );
    ...
    function updateHeaderPosition(header) {
      ...
      if (
        headerGroupEls.length === 1 &&
        firstEl.querySelector(selectors.wrapper)
      ) {
      ...
      if (
        firstEl.querySelector(selectors.wrapper) &&
        secondEl.querySelector(".announcement")
      ) {
    ...
    function toggleThumbMenu(active, forceClose) {
      ...
      menuElement &&
        menuElement.classList.toggle(classes.thumbMenuInactive, !active);
  ...
  theme.StickyCart = (function () {
    ...
    function refresh(cart) {
      ...
      document.querySelector(selectors.items).innerText =
        theme.strings.cartItems.replace("[count]", cart.item_count);
      document.querySelector(selectors.subtotal).innerHTML =
  ...
  theme.Product = (function () {
    ...
    function Product(container) {
      ...
      this.settings = {
        ...
        hasImages: true,
        hasVideos:
          container.querySelectorAll(selectors.productVideo).length || false,
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      init: function () {
        ...
        this.settings.imageSetName = dataSetEl
      ...
      updateColorName: function (color, index) {
        ...
        var label = this.container.querySelector(
          '[data-color-label][data-color-label-index="' + index + '"]'
        );
        if (label) {
      ...
      updatePrice: function (evt) {
        ...
        if (variant) {
          // Regular price
          this.container.querySelector(selectors.price).innerHTML =
            theme.Currency.formatMoney(
              variant.price,
              theme.settings.moneyFormat
            );
          ...
          if (variant.compare_at_price > variant.price) {
            this.container.querySelector(selectors.comparePrice).innerHTML =
              theme.Currency.formatMoney(
                variant.compare_at_price,
                theme.settings.moneyFormat
              );
            this.container
              .querySelector(selectors.priceWrapper)
              .classList.remove(classes.hidden);
            this.container
              .querySelector(selectors.price)
              .classList.add(classes.onSale);
            this.container
              .querySelector(selectors.comparePriceA11y)
              .setAttribute("aria-hidden", "false");
            this.container
              .querySelector(selectors.priceA11y)
              .setAttribute("aria-hidden", "false");
          } else {
            ...
            if (
              this.container.querySelector(selectors.priceWrapper) &&
              this.container.querySelector(selectors.comparePriceA11y)
            ) {
              this.container
                .querySelector(selectors.priceWrapper)
            ...
            this.container
              .querySelector(selectors.price)
              .classList.remove(classes.onSale);
            this.container
              .querySelector(selectors.priceA11y)
              .setAttribute("aria-hidden", "true");
          }
      ...
      updateUnitPrice: function (evt) {
        ...
        if (variant && variant.unit_price) {
          ...
          this.container
            .querySelector(selectors.unitWrapper)
      ...
      toggleInventoryQuantity: function (variant, variantInventoryObject) {
        ...
        if (
          ...
          if (quantity > 1) {
            el.textContent = theme.strings.otherStockLabel.replace(
              "[count]",
              quantity
            );
          } else {
            el.textContent = theme.strings.oneStockLabel.replace(
              "[count]",
              quantity
            );
          }
      ...
      ==============================================================================*/
      videoSetup: function () {
        var productVideos = this.mainSlider.querySelectorAll(
      ...
      _isFirstSlide: function (id) {
        return this.mainSlider.querySelector(
      ...
      initProductSlider: function (variant) {
        ...
        this.settings.has3d = this.container.querySelectorAll(
          selectors.media
        ).length;
        ...
        // currentSlideIndex
        if (!variant) {
          var activeSlide = this.mainSlider.querySelector(
        ...
        var mainSliderArgs = {
          ...
          childNavScroller: this.container.querySelector(
            selectors.thumbScroller
          ),
      ...
      onSlideChange: function (index) {
        ...
        var prevSlide = this.mainSlider.querySelector(
        ...
        var nextSlide = this.settings.imageSetName
          ? this.mainSlider.querySelectorAll(
              ".flickity-slider .product-main-slide"
            )[index]
          : this.mainSlider.querySelector(
      ...
      updateVariantImage: function (evt) {
        ...
        var newImage = this.container.querySelector(
          '.product-main-slide[data-id="' + variant.featured_media.id + '"]'
        );
          ...
          thumb.addEventListener(
            ...
            function (evt) {
              ...
              if (!theme.config.bpSmall) {
                if (this.settings.stackedImages) {
                  this.container
                    .querySelectorAll(selectors.photoThumbItem)
                    .forEach((el) => {
      ...
      stackedImagesInit: function () {
        ...
        window.on(
          "resize" + this.namespaceImages,
          theme.utils.debounce(200, this.stackedImagePositions.bind(this))
        );
      ...
      stackedActive: function (index) {
        ...
        var thumb = this.container.querySelectorAll(
          selectors.photoThumbItem + ":not(.hide"
        )[index];
        if (thumb) {
        ...
        if (this.settings.hasVideos) {
          ...
          var video = this.container
            .querySelectorAll(selectors.photo)
            [index].querySelector(".product__video");
        ...
        if (this.settings.has3d) {
          ...
          if (allMedia.length) {
            allMedia.forEach((el) => {
              el.dispatchEvent(new CustomEvent("mediaHidden"));
            });
          }

          var media = this.container
            .querySelectorAll(selectors.photo)
            [index].querySelector(selectors.media);

          if (media) {
            media.dispatchEvent(new CustomEvent("mediaVisible"));
          }
        }
      ...
      initSliders: function (args, reload) {
        ...
        var imageContainer = this.container.querySelector(
          ...
          fetch(url)
            ...
            .then(
              function (html) {
                ...
                var allSections = doc.querySelectorAll(
                  "#MainContent .shopify-section:not(.shopify-section__product)"
                );
                if (allSections.length) {
                  this.loadProductSections(allSections);
                }

                var socialDiv = doc.querySelector(
      ...
      unloadProductSections: function () {
        var holder = document.querySelector(
          "#ProductSectionsHolder-" + this.productId
        );
      ...
      loadSocialSection: function (content) {
        var holder = document.querySelector(
          "#SocialSectionHolder-" + this.productId
        );
        if (holder) {
      ...
      customMediaListners: function () {
        this.container.querySelectorAll(selectors.closeMedia).forEach((el) => {
          el.addEventListener(
            ...
            function () {
              if (this.settings.stackedImages) {
                var slide = this.mainSlider.querySelector(
                  '.product-main-slide[data-index="' +
                    this.settings.currentSlideIndex +
                    '"]'
                );
    ...
    HeaderSection.prototype = Object.assign({}, HeaderSection.prototype, {
      ...
      hoverMenu: function () {
        const detailsEl = document.querySelectorAll(
          '[data-section-type="header-section"] details[data-hover="true"]'
        );
  ...
  theme.CollectionFilter = (function () {
    ...
    CollectionFilter.prototype = Object.assign({}, CollectionFilter.prototype, {
      ...
      renderCollectionPage: function (searchParams) {
        theme.CollectionAjaxFilter(searchParams).then(() => {
          isAnimating = false;
          this.initPriceRange();
      ...
      FeaturedCollection.prototype,
      {
        init: function () {
          ...
          window.on(
            ...
            theme.utils.debounce(200, this.handleResize.bind(this))
          );
        ...
        toggleScrollListener: function (enable) {
          if (enable) {
            ...
            this.scrollWrap.on(
              ...
              theme.utils.throttle(250, this.scrollCheck.bind(this))
            );
        ...
        arrowScroll: function (evt) {
          var direction = evt.currentTarget.classList.contains(
            classes.arrowLeft
          )
            ? "left"
            : "right";
  ...
  theme.Testimonials = (function () {
    ...
    Testimonials.prototype = Object.assign({}, Testimonials.prototype, {
      init: function (obj, args) {
        ...
        this.flickity.play(); //sean 20240429
      },
  ...
  theme.HeroAnimated = (function () {
    ...
    function HeroAnimated(container) {
      ...
      this.allImages = Array.from(
        container.querySelectorAll(".animated__slide")
      );

      this.slidesWithImages = Array.from(
        container.querySelectorAll("[data-slide-with-image]")
      );
  ...
  theme.NewsletterPopup = (function () {
    function NewsletterPopup(container) {
      ...
      //20240618seanzeus if (!this.cookie) {
      this.initPopupDelay();
      //20240618seanzeus }
    ...
    NewsletterPopup.prototype = Object.assign({}, NewsletterPopup.prototype, {
      initPopupDelay: function () {
        ...
        setTimeout(
          function () {
            //20240618seanzeus const newsletterAppeared = (sessionStorage.getItem('newsletterAppeared') === 'true');
            const newsletterAppeared =
              localStorage.getItem("newsletterAppeared") ==
              new Date().getDate();
            if (newsletterAppeared) {
              ...
              this.modal.open();
              //20240618seanzeus sessionStorage.setItem('newsletterAppeared', true);
              localStorage.setItem("newsletterAppeared", new Date().getDate());
            }
          }.bind(this),
  ...
  class HotSpots extends HTMLElement {
    ...
    _removeActiveColorImage(swatch) {
      const id = swatch.dataset.variantId;
      this.querySelector(`.grid-product__color-image--${id}`).classList.remove(
        "is-active"
      );
    }
  ...
  theme.reviewAppLinkListener = function () {
    document.addEventListener("click", function (evt) {
      ...
      if (
        parent.matches(".spr-pagination-next") ||
        parent.matches(".spr-pagination-page")
      ) {
  ...
  DOMready(function () {
    ...
    //seanzeus20250317 判斷切換語言停留在原地
    let _desk_lang = window.location.pathname;
    if (_desk_lang.indexOf("/zh-") != -1) {
      _desk_lang = _desk_lang.substring(6);
    } else if (_desk_lang.indexOf("/zh/") != -1) {
      _desk_lang = _desk_lang.substring(3);
    } else if (_desk_lang.indexOf("/en-") != -1) {
      _desk_lang = _desk_lang.substring(6);
    } else if (_desk_lang.indexOf("/en/") != -1) {
      _desk_lang = _desk_lang.substring(3);
    } else if (_desk_lang.indexOf("/fr-") != -1) {
      _desk_lang = _desk_lang.substring(6);
    } else if (_desk_lang.indexOf("/fr/") != -1) {
      _desk_lang = _desk_lang.substring(3);
    } else if (
      _desk_lang.indexOf("/en") != -1 || _desk_lang.indexOf("/zh") != -1 || _desk_lang.indexOf("/fr") != -1 ) {
