      ...
      var o =
        ...
        v = function () {
          if (
            ...
            return (p = (0, d.default)(p, g)), (0, u.default)(p, g.once), p;
        },
        y = function () {
          (p = (0, h.default)()), v();
        };
    ...
    function (t, e) {
      (function (e) {
        ...
        function i(t, e, i) {
          ...
          function s(t) {
            var i = t - g;
            return void 0 === g || i >= e || i < 0 || (S && t - v >= p);
          }
          function l() {
            var t = w();
            return s(t)
              ...
              : void (m = setTimeout(
                  ...
                  (function (t) {
                    var i = e - (t - g);
                    return S ? x(i, p - (t - v)) : i;
                  })(t)
                ));
          }
          function c(t) {
            return (m = void 0), E && d ? o(t) : ((d = h = void 0), f);
          }
          function u() {
            var t = w(),
              i = s(t);
            if (((d = arguments), (h = this), (g = t), i)) {
              if (void 0 === m)
                return (function (t) {
                  return (v = t), (m = setTimeout(l, e)), y ? o(t) : f;
                })(g);
              if (S) return (m = setTimeout(l, e)), o(g);
            }
          ...
          return (
            ...
            n(i) &&
              ((y = !!i.leading),
              (p = (S = "maxWait" in i) ? b(r(i.maxWait) || 0, e) : p),
      ...
      (function (e) {
        ...
        t.exports = function (t, e, n) {
          ...
          function l() {
            ...
            return a(t)
              ...
              : void (m = setTimeout(
                  ...
                  (function (t) {
                    var i = e - (t - g);
                    return S ? b(i, p - (t - v)) : i;
                  })(t)
                ));
          }
          function c(t) {
            return (m = void 0), E && d ? r(t) : ((d = h = void 0), f);
          }
          function u() {
            var t = x(),
              i = a(t);
            if (((d = arguments), (h = this), (g = t), i)) {
              if (void 0 === m)
                return (function (t) {
                  return (v = t), (m = setTimeout(l, e)), w ? r(t) : f;
                })(g);
              if (S) return (m = setTimeout(l, e)), r(g);
            }
            return void 0 === m && (m = setTimeout(l, e)), f;
          }
          var d,
          ...
          return (
            ...
            i(n) &&
              ((w = !!n.leading),
              (p = (S = "maxWait" in n) ? y(o(n.maxWait) || 0, e) : p),
          ...
          for (
            ...
            try {
              ...
              if (
                ((f = i.read
                  ? i.read(f, m)
                  : i(f, m) || f.replace(d, decodeURIComponent)),
                this.json)
              )
                try {
                  f = JSON.parse(f);
    ...
    return function (t, e, i, n) {
      ...
      var a,
        ...
        _t = function (t, e, i, n, o) {
          (!xt || (o && o !== r.currItem)) &&
            ...
            (t[_] = y + e + "px, " + i + "px" + b + " scale(" + n + ")");
        },
        It = function (t) {
          et &&
            (t &&
              (g > r.currItem.fitRatio
                ? xt || (Ke(r.currItem, !1, !0), (xt = !0))
                : xt && (Ke(r.currItem), (xt = !1))),
            _t(et, dt.x, dt.y, g));
        },
        At = function (t) {
          t.container &&
        ...
        Mt = function (t, e) {
          if (!s.loop && e) {
            var i = u + (mt.x * pt - t) / mt.x,
              n = Math.round(t - ue.x);
            ((i < 0 && n > 0) || (i >= We() - 1 && n < 0)) &&
              (t = ue.x + n * s.mainScrollEndFriction);
          }
          (ue.x = t), Tt(t, d);
        },
        zt = function (t, e) {
        ...
        Nt = function () {
          Ft &&
            (o.unbind(document, "mousemove", Nt),
        ...
        Ht = function (t) {
          t && (Y || X || it || H) && (t.preventDefault(), t.stopPropagation());
        },
        qt = function () {
        ...
        Zt = 0,
        Xt = function (t) {
          Bt[t] && (Bt[t].raf && M(Bt[t].raf), Zt--, delete Bt[t]);
        },
        Yt = function (t) {
          Bt[t] && Xt(t), Bt[t] || (Zt++, (Bt[t] = {}));
        },
        Gt = function () {
        ...
        Kt = function (t, e, i, n, o, r, s) {
          ...
          var c = function () {
            if (Bt[t]) {
              if ((a = kt() - l) >= n) return Xt(t), r(i), void (s && s());
              r((i - e) * o(a / n) + e), (Bt[t].raf = T(c));
            }
          };
          c();
        },
        $t = {
          ...
          setScrollOffset: function (t, e) {
            (ft.x = t), (F = ft.y = e), Dt("updateScrollOffset", ft);
          },
          applyZoomPan: function (t, e, i, n) {
            (dt.x = e), (dt.y = i), (g = t), It(n);
          },
          init: function () {
            if (!a && !l) {
              var i;
              ...
              Dt("firstUpdate"),
                (u = u || s.index || 0),
                (isNaN(u) || u < 0 || u >= We()) && (u = 0),
                (r.currItem = je(u)),
                (N.isOldIOSPhone || N.isOldAndroid) && (vt = !1),
                ...
                void 0 === F && (Dt("initialLayout"), (F = L = o.getScrollY()));
              var c = "pswp--open ";
              for (
                ...
                Tt((i + h) * mt.x, S[i].el.style);
              O || o.bind(r.scrollWrap, f, r),
                Ct("initialZoomInEnd", function () {
                  r.setContent(S[0], u - 1),
                    ...
                    s.mouseUsed || o.bind(document, "mousemove", Nt),
          ...
          close: function () {
            a &&
              ...
              B && o.unbind(window, p, r),
              clearTimeout(U),
              Dt("unbindEvents"),
              Ve(r.currItem, null, !0, r.destroy));
          },
          destroy: function () {
            Dt("destroy"),
              Fe && clearTimeout(Fe),
            ...
            if (0 !== gt) {
              ...
              if (!(t && i < 2)) {
                (r.currItem = je(u)),
                  (xt = !1),
                  Dt("beforeChange", gt),
                  i >= 3 && ((h += gt + (gt > 0 ? -3 : 3)), (i = 3));
                for (var n = 0; n < i; n++)
                  gt > 0
                    ? ((e = S.shift()),
                      (S[2] = e),
                      h++,
                      Tt((h + 2) * mt.x, e.el.style),
                      r.setContent(e, u - i + n + 1 + 1))
                    : ((e = S.pop()),
                      S.unshift(e),
                      h--,
                      Tt(h * mt.x, e.el.style),
                      r.setContent(e, u + i - n - 1 - 1));
                if (et && 1 === Math.abs(gt)) {
                  var o = je(E);
                  o.initialZoomLevel !== g && (Ze(o, ht), Ke(o), At(o));
                }
                (gt = 0), r.updateCurrZoomItem(), (E = u), Dt("afterChange");
              }
            }
          },
          updateSize: function (e) {
            ...
            if (
              ((ht.x = r.scrollWrap.clientWidth),
              (ht.y = r.scrollWrap.clientHeight),
              qt(),
              (mt.x = ht.x + Math.round(ht.x * s.spacing)),
              (mt.y = ht.y),
              Mt(mt.x * pt),
              Dt("beforeResize"),
              void 0 !== h)
              ...
              for (var n, a, l, c = 0; c < 3; c++)
                (n = S[c]),
                  Tt((c + h) * mt.x, n.el.style),
                  (l = u + c - 1),
                  s.loop && We() > 2 && (l = St(l)),
                  (a = je(l)) && (w || a.needsUpdate || !a.bounds)
                    ? (r.cleanSlide(a),
                      r.setContent(n, l),
                      1 === c && ((r.currItem = a), r.updateCurrZoomItem(!0)),
                      (a.needsUpdate = !1))
                    : -1 === n.index && l >= 0 && r.setContent(n, l),
                  a && a.container && (Ze(a, ht), Ke(a), At(a));
              w = !1;
            }
            (v = g = r.currItem.initialZoomLevel),
              (tt = r.currItem.bounds) &&
                ((dt.x = tt.center.x), (dt.y = tt.center.y), It(!0)),
              Dt("resize");
          },
          zoomTo: function (t, e, i, n, r) {
            e &&
              ((v = g),
              (de.x = Math.abs(e.x) - dt.x),
              (de.y = Math.abs(e.y) - dt.y),
              Lt(ut, dt));
            var s = Ut(t, !1),
              a = {};
            Wt("x", s, a, t), Wt("y", s, a, t);
            var l = g,
              c = dt.x,
              u = dt.y;
            Ot(a);
        ...
        De = function (t) {
          ...
          return (
            I
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Ce[0] = be(t.touches[0], Se)),
                t.touches.length > 1 && (Ce[1] = be(t.touches[1], Ee)))
              : ((Se.x = t.pageX),
                (Se.y = t.pageY),
                (Se.id = ""),
                (Ce[0] = Se)),
        ...
        ke = function (t, e) {
          ...
          if (
            ...
            return (
              void 0 !== a && (Mt(a, !0), (K = a !== oe.x)),
              tt.min.x !== tt.max.x &&
                (void 0 !== o ? (dt.x = o) : K || (dt.x += e.x * i)),
              void 0 !== a
            );
        ...
        Pe = function (t) {
          if (!("mousedown" === t.type && t.button > 0))
            if (Re) t.preventDefault();
              ...
              if ((ye(t, !0) && t.preventDefault(), Dt("pointerDown"), I)) {
              ...
              ($ = null),
                ...
                !J &&
                  ...
                  Lt(Qt, i[1]),
                  xe(Jt, Qt, he),
                  (de.x = Math.abs(he.x) - dt.x),
                  (de.y = Math.abs(he.y) - dt.y),
                  (Q = pe(Jt, Qt)));
            }
        },
        _e = function (t) {
              ...
              if (
                ...
                i >
                  r.currItem.initialZoomLevel +
                    r.currItem.initialZoomLevel / 15 && (at = !0);
                var n = 1,
                  o = Rt(),
                  a = jt();
                if (i < o)
                ...
                if (
                  (ot &&
                    ((ot = !1),
                    Math.abs(te.x) >= 10 && (te.x -= $[0].x - ie.x),
                    Math.abs(te.y) >= 10 && (te.y -= $[0].y - ie.y)),
                  (ee.x = Jt.x),
                  (ee.y = Jt.y),
                  0 === te.x && 0 === te.y)
                )
                ...
                if (
                  ...
                  (ct.y += te.y), (dt.y += te.y);
                  var c = we();
                  return (H = !0), Dt("onVerticalDrag", c), Pt(c), void It();
                }
                !(function (t, e, i) {
                  if (t - j > 50) {
        ...
        Ae = function (t) {
          ...
          var e;
          if ((Dt("pointerUp"), ye(t, !1) && t.preventDefault(), I)) {
          ...
          if (
            ...
            if ((Gt(), W || (W = Te()), W.calculateSwipeSpeed("x"), H)) {
              ...
              it ||
                ("swipe" === n ? !K && g > r.currItem.fitRatio && Me(W) : Oe());
            }
        },
        Te = function () {
          var t,
            ...
            i = {
              ...
              panAnimLoop: function () {
                if (
                  Bt.zoomPan &&
                  ((Bt.zoomPan.raf = T(i.panAnimLoop)),
                  (i.now = kt()),
        ...
        Me = function (t) {
          ...
          Yt("zoomPan"), (t.lastNow = kt()), t.panAnimLoop();
        },
        ze = function (t, e) {
          var i, n, a;
          if ((it || (ae = u), "swipe" === t)) {
          ...
          n &&
            ((u += n) < 0
              ? ((u = s.loop ? We() - 1 : 0), (a = !0))
              : u >= We() && ((u = s.loop ? 0 : We() - 1), (a = !0)),
            (a && !s.loop) || ((gt += n), (pt -= n), (i = !0)));
          var d,
            h = mt.x * pt,
            p = Math.abs(h - ue.x);
          return (
            i || h > ue.x == e.lastFlickSpeed.x > 0
              ? ((d =
            ...
            Kt("mainScroll", ue.x, h, d, o.easing.cubic.out, Mt, function () {
              Gt(),
                (it = !1),
                (ae = -1),
                (i || ae !== u) && r.updateCurrItem(),
                Dt("mainScrollAnimComplete");
            }),
      ...
      var Fe,
        ...
        Ve = function (e, i, n, a) {
          ...
          var p, f;
          (p = c),
            (f = !r.currItem.src || r.currItem.loadError || s.showHideOpacity),
            e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"),
            n ||
              ((g = l.w / e.w),
              (dt.x = l.x),
              (dt.y = l.y - L),
              (r[f ? "template" : "bg"].style.opacity = 0.001),
              It()),
            Yt("initialZoom"),
            n && !p && o.removeClass(t, "pswp--animated-in"),
            f &&
              (n
                ? o[(p ? "remove" : "add") + "Class"](
                    t,
              ...
              function () {
                if ((Dt("initialZoom" + (n ? "Out" : "In")), n)) {
                  var i = l.w / e.w,
                    ...
                    c = function (e) {
                      1 === e
                        ? ((g = i), (dt.x = l.x), (dt.y = l.y - F))
                        : ((g = (i - s) * e + s),
                          (dt.x = (l.x - r.x) * e + r.x),
                          (dt.y = (l.y - F - r.y) * e + r.y)),
                        It(),
                        f ? (t.style.opacity = 1 - e) : Pt(a - e * a);
                    };
                  p
                    ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, c, h)
                    : (c(1), (Fe = setTimeout(h, d + 20)));
                } else
                  (g = e.initialZoomLevel),
                    Lt(dt, e.initialPosition),
                    It(),
                    Pt(1),
                    f ? (t.style.opacity = 1) : Pt(1),
          ...
          if (qe.length) {
            for (var t, e = 0; e < qe.length; e++)
              (t = qe[e]).holder.index === t.index &&
                Xe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            qe = [];
          }
        };
      wt("Controller", {
        publicMethods: {
          ...
          initController: function () {
            o.extend(s, Be, !0),
              ...
              Ct("mainScrollAnimComplete", $e),
              Ct("initialZoomInEnd", $e),
              Ct("destroy", function () {
                for (var t, e = 0; e < Ne.length; e++)
                  (t = Ne[e]).container && (t.container = null),
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              Ue || e !== u ? At(l) : ((et = c.style), Ve(l, n || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(c);
            } else t.el.innerHTML = "";
          },
          ...
          publicMethods: {
            ...
            handleMouseWheel: function (t) {
              if (g <= r.currItem.fitRatio)
                return (
                  s.modal &&
                    (!s.closeOnScroll || Zt || B
                      ? t.preventDefault()
                      : _ && Math.abs(t.deltaY) > 2 && ((c = !0), r.close())),
                  !0
                );
              if ((t.stopPropagation(), (Qe.x = 0), "deltaX" in t))
                1 === t.deltaMode
                  ? ((Qe.x = 18 * t.deltaX), (Qe.y = 18 * t.deltaY))
                  : ((Qe.x = t.deltaX), (Qe.y = t.deltaY));
              else if ("wheelDelta" in t)
                t.wheelDeltaX && (Qe.x = -0.16 * t.wheelDeltaX),
                  t.wheelDeltaY
                    ? (Qe.y = -0.16 * t.wheelDeltaY)
                    : (Qe.y = -0.16 * t.wheelDelta);
              else {
  ...
  (function (t, e) {
    ...
    return function (t, e) {
      var i,
        ...
        D = function (t) {
          if (v) return !0;
          (t = t || window.event), g.timeToIdle && g.mouseUsed && !u && L();
          for (
            var i,
              n,
      ...
      (x.init = function () {
        ...
        e.extend(t.options, C, !0),
          ...
          d("onPinchClose", function (t) {
            S && t < 0.9
              ? (x.hideControls(), (s = !0))
              : s && !S && t > 0.9 && x.showControls();
          }),
          d("zoomGestureEnded", function () {
            (s = !1) && !S && x.showControls();
          }),
        ...
        (x.onGlobalTap = function (i) {
          ...
          if (!v)
            if (i.detail && "mouse" === i.detail.pointerType) {
              ...
              g.tapToClose && (e.hasClass(n, "pswp__img") || M(n)))
            )
              return void t.close();
        }),
  ...
  (function (t, e) {
    ...
    function X(e, i, n) {
      var a,
        ...
        I = {},
        A = e.ownerDocument,
        T = i.documentElement || A.documentElement,
        M = A.body,
        z = "rtl" === A.dir || 1 === i.ort ? 0 : 100;
      function L(t, e) {
      ...
      function O(t, e) {
        ...
        return (
            ...
            o.addEventListener("keydown", function (t) {
              return (function (t, e) {
                ...
                if ((t.preventDefault(), h || d)) {
                  ...
                  if (null === v) return !1;
                  !1 === v &&
                    (v = C.getDefaultStep(k[e], d, i.keyboardDefaultStep)),
                    (u || c) && (v *= m),
                    (v = Math.max(v, 1e-7)),
                    (v *= d ? -1 : 1),
                    (a = D[e] + v);
          ...
          0 === e
            ? h(o, i.cssClasses.handleLower)
            : e === i.handles - 1 && h(o, i.cssClasses.handleUpper),
          n
        );
      }
      function F(t, e) {
      ...
      function N(t, e) {
        return (
          ...
          L(t.firstChild, i.cssClasses.tooltip)
        );
      }
      function U() {
      ...
      function W() {
        j(),
          (v = d.map(N)),
          nt("update" + E.tooltips, function (t, e, n) {
        ...
        return (
          ...
          n.forEach(function (i, r) {
            ...
            for (
              ...
              for (
                g = (p = (h = C.toStepping(u)) - c) / (e.density || 1),
                  y = p / (v = Math.round(g)),
                  d = 1;
                d <= v;
                d += 1
              )
                o[(f = c + d * y).toFixed(5)] = [C.fromStepping(f), 0];
              (m =
                n.indexOf(u) > -1
              ...
              if ((s = n ? n(r, s) : s) !== t.PipsType.None) {
                ...
                (l.className = p(s, i.cssClasses.marker)),
                  ...
                  s > t.PipsType.NoValue &&
                    (((l = L(a, !1)).className = p(s, i.cssClasses.value)),
      ...
      function Q(t, e) {
        e.handle && (p(e.handle, i.cssClasses.active), (_ -= 1)),
          ...
          0 === _ &&
            (p(S, i.cssClasses.drag),
            ut(),
            t.cursor &&
              ((M.style.cursor = ""), M.removeEventListener("selectstart", s))),
        ...
        if (!e.handleNumbers.some(R)) {
          ...
          o.push.apply(o, r.concat(a, l)),
            t.cursor &&
              ...
              d.length > 1 && h(S, i.cssClasses.drag),
              M.addEventListener("selectstart", s, !1)),
            e.handleNumbers.forEach(function (t) {
              rt("start", t);
            });
        }
      ...
      function dt(t, e, n, o, r) {
        return (
          ...
          !1 !== e &&
            ((function (t, e) {
              (k[t] = e), (D[t] = C.fromStepping(e));
              var n = "translate(" + at(10 * (ct(e, 0) - z) + "%", "0") + ")";
      ...
      function ft(t, e, n) {
        ...
        ut(),
          P.forEach(function (t) {
            rt("update", t), null !== o[t] && e && rt("set", t);
          });
      }
      function mt(t) {
        if ((void 0 === t && (t = !1), t))
      ...
      h((y = S), i.cssClasses.target),
        0 === i.dir ? h(y, i.cssClasses.ltr) : h(y, i.cssClasses.rtl),
        0 === i.ort
          ? h(y, i.cssClasses.horizontal)
          : h(y, i.cssClasses.vertical),
        h(
          y,
        ...
        i.tooltips && W(),
        ot("update" + E.aria),
        nt("update" + E.aria, function (t, e, n, o, r) {
          P.forEach(function (t) {
            var e = d[t],
              o = st(k, t, 0, !0, !0, !0),
              s = st(k, t, 100, !0, !0, !0),
      ...
      var vt = {
        ...
        setHandle: function (t, e, i, n) {
          ...
          dt(t, pt(e, t), !0, !0, n), rt("update", t), i && rt("set", t);
        },
        reset: function (t) {
          ft(i.start, t);
        },
